...
const ru: Translation = {
  ...
  helpBonuses: 'Бонусы',
  helpBonusesBody: 'Посмотрите рекламу, чтобы удвоить доход от аренды на 5 минут или пригласить VIP-жильца с двойным доходом на 10 минут.',
  ...
  content: {
    modules: {
      ...
      saucer_dock: { name: 'Док для мини-тарелок', role: 'Транспортный узел' },
...
const en: Translation = {
  ...
  helpBonuses: 'Bonuses',
  helpBonusesBody: 'Watch an ad to double rent income for 5 minutes or invite a VIP resident with double income for 10 minutes.',
  ...
  content: {
    modules: {
      ...
      saucer_dock: { name: 'Mini-Saucer Dock', role: 'Transport hub' },
