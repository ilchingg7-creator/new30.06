...
const visitorTemplates: VisitorTemplate[] = [
  ...
  },
  {
    ...
    flavor: '«Я просто хотел посмотреть на звёзды... Дайте мне кров, и я расскажу всем о вашей коммуналке!»',
    costMultiplier: 1.5,
    rewardComfort: 4,
...
export function generateVisitorRequest(state: GameState, now = Date.now()): VisitorRequest | null {
  // Only spawn a visitor if the player has at least one module and no active visitor.
