...
function registerRoomSpriteAsset(asset: RoomSpriteAsset) {
  if (registeredRoomSpriteAliases.has(asset.alias)) {
    return;
  }
 ...
 * corresponds to 10 module levels and swaps the room artwork to a richer
 * variant.
 *
